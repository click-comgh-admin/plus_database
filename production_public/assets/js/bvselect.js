...
class BVSelect {
    ...
    constructor({
        ...
        this.CriarDivBase = function() {
            ...
            let _selector = this.selector.substring(1);
            document.querySelector(this.selector).insertAdjacentHTML('afterend', '<div id="bv_' + randomID + '" data-search="' + this.searchbox + '" class="bv_mainselect this_' + _selector + '"></div>');
            // document.querySelector(this.selector).insertAdjacentHTML('afterend', '<div id="bv_' + randomID + '" data-search="' + this.searchbox + '" class="bv_mainselect"></div>');
    ...
    SetOption(properties) {
            ...
            if (properties.type == "byIndex") {
                ...
                // Trigger onchange function
                if (selectorIndex.getAttribute("onchange") != null) { document.querySelector(this.selector).onchange(); }
