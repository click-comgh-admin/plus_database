...
class WebpackLoader
{
    ...
    public function load_assets(){
        try {
            $fopen = fopen($this->config['STATS_FILE'], 'r');
            print_r(['$fopen' => $fopen]);
        } catch (\Throwable $th) {
            throw $th;
        }
    ...
    // public function filter_chunks(self, chunks){
    //     filtered_chunks = []
    ...
    // public function map_chunk_files_to_url(self, chunks){
    ...
    // public function get_chunk_url(self, chunk_file){
    ...
    // public function get_bundle(self, bundle_name){
    //     assets = self.get_assets()
