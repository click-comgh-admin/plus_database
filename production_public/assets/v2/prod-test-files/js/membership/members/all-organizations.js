              ...
              <accordion-item title="Location Filter">
                <div class="mt-1 mb-2 row">
                  <div class="col-xl-6 col-md-6">
                    ...
                    <select-input name="${s}" id="${s}" label="Select Country" .options="${B}"
                      outlined required>
                    </select-input>
                  </div>
                  <div class="col-xl-6 col-md-6" show_ghana_locations>
                    <h4 class="font-semibold my-2">Select Region</h4>
                    <select-input name="${l}" id="${l}" label="Select Region" .options="${$}"
                      outlined required>
                    </select-input>
                  </div>
                  <div class="col-xl-6 col-md-6" show_ghana_locations>
