<?php
    ...
    define('PAGE_TITLE', "Visitors => Print Visitors");
    define('PAGE_DESC', "Print Visitors");
?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="app-main__inner">
                        ...
                        <?php
                            ...
                            foreach ($appPages as $key => $page) {
                                if ((string)strtolower($page['pdpc_page']) === "office visitors") {
                            ...
                            define("Current_BaseUrl", CLIENT_BASE_URL."office/visitors/");
                            define("Current_BaseDir", BASE_DIRECTORY."/office/visitors/");
