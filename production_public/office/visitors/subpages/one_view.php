                ...
                <div class="table-responsive border border-warning"><?php //print_r($visitor); ?>
                    <table class="mb-0 table table-striped table-hover" pagin_table="office_visitors_one" pt_c_cid="<?= AccountInfoId; ?>" 
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th  style="white-space: nowrap;">
                                    Email: <a href="mailto:<?= isset($visitor['pdov_email'])? $visitor['pdov_email']: ""; ?>">
                                    <?= isset($visitor['pdov_email'])? $visitor['pdov_email']: ""; ?></a>
                                </th>
                                <td  style="white-space: nowrap;">
                                    Description: 
                                    <?php 
                                        $get_string = "office/visitors/visitor_description_client?client-id=".AccountInfoId."&id=".(isset($visitor['pdov_visitor_description'])? $visitor['pdov_status_of_visit']: 0);
                                        echo $ccApi->fetch_from($get_string=$get_string, function($status) {
                                            return isset($status[0])? $status[0]['pdd_info']: "-";
                                        });
                                    ?>
                                ...
                                <td  style="white-space: nowrap;">
                                    Entered By: <?= isset($visitor['pdov_entered_by'])? $visitor['pdov_entered_by']: ""; ?>
                                </td>
                            </tr>
                            <tr>
