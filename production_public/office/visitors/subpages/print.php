        ...
        <div class="main-card mb-3 card shadow">
            <div class="card-body px-2">
                ...
                <div class="table-responsive">
                    <table class="mb-0 table table-striped" pagin_table="office_visitors_print" pt_c_by_date="1" pt_c_user="<?= $user_id; ?>"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="white-space: nowrap;"><sapn class="d-none">Status of Visit</sapn></th>
                                <th style="white-space: nowrap;"><sapn class="d-none">Visitor Description</sapn></th>
                                <th style="white-space: nowrap;"><sapn class="d-none">Host</sapn></th>
                                <th style="white-space: nowrap;">Host Department</th>
                                <th style="white-space: nowrap;"><sapn class="d-none">Reason For Visit</sapn></th>
                                <th style="white-space: nowrap;">Visit Date</th>
                                <th style="white-space: nowrap;">Entered By</th>
                                <th style="white-space: nowrap;">Visitor's Action</th>
                                <th style="white-space: nowrap;"><sapn class="d-none">Appointment</sapn></th>
                                <th style="white-space: nowrap;"><sapn class="d-none">Note</sapn></th>
                                <th style="white-space: nowrap;"><sapn class="d-none">Created By</sapn></th>
