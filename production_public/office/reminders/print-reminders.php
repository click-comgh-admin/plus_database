<?php
    ...
    define('PAGE_TITLE', "Reminders => Print Reminders");
    define('PAGE_DESC', "Print Reminders");
?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-alarm icon-gradient bg-grow-early">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                        ...
                        <?php
                            ...
                            foreach ($appPages as $key => $page) {
                                if ((string)strtolower($page['pdpc_page']) === "office reminders") {
                            ...
                            define("Current_BaseUrl", CLIENT_BASE_URL."office/reminders/");
                            define("Current_BaseDir", BASE_DIRECTORY."/office/reminders/");
                            
                            
                        ?>
                        <?php
                            require_once('subpages/print.php');
                        ?>
                    </div>
