        ...
        <div class="main-card mb-3 card shadow">
            <div class="card-body px-2">
                ...
                <div class="d-none d-lg-block table-responsive">
                    <table class="mb-0 table table-striped" pagin_table="office_reminders" pt_c_by_date="1" pt_c_user="<?= $user_id; ?>"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="white-space: nowrap;">Reminder</th>
                ...
                <div class="d-block d-lg-none table-responsive">
                    <table class="mb-0 table table-striped" pagin_table="office_reminders_sm" pt_c_by_date="1" pt_c_user="<?= $user_id; ?>"
                        pt_c_start_date="<?= $start_date; ?>" pt_c_end_date="<?= $end_date; ?>" pt_c_cid="<?= AccountInfoId; ?>" 
                        pt_c_by_reminder_status="<?= $by_reminder_status; ?>" pt_c_reminder_status="<?= $this_reminder_status; ?>" 
                        pt_c_by_group_id="<?= $by_group_id; ?>" pt_c_group_id="<?= $this_group_id; ?>">
                        <thead>
                            <tr>
                                ...
                                <th style="white-space: nowrap;">Meeting Info</th>
                                <th style="white-space: nowrap;">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
