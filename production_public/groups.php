<?php
    ...
    if (AccountInfoCategory === 10) {
        define('PAGE_TITLE', "Departments");
        define('PAGE_DESC', "View All Departments");
    } else {
        define('PAGE_TITLE', "Groups");
        define('PAGE_DESC', "View All Groups");
    }
?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="app-main__inner">
                        ...
                        <?php
                                    ...
                                    <a href="#" data-toggle="modal" open-modal--id="subgroups-<?= $group['pdmg_id']; ?>"
                                        open-modal--title="<?= $group['pdmg_group']; ?> <?= ((int)AccountInfoType === 10) ? "Units": "Sub-Groups"; ?>" open-modal--html='<?php 
                                            ...
                                            if (!empty($subgroups)) {
                                                ...
                                                echo "No ".((int)AccountInfoType === 10) ? "Units": "Sub-Groups"."(s) Created";
                                            }
                                        ?>' open-modal--buttons='
                                ...
                                function edit_btn($group, $account_id, $user_id, $confirm_msg, $class, $tf, $type = "md") { ?>
                                    <button class="<?= $class; ?>" type="button" data-toggle="modal"
                                        ...
                                        open-modal--title="Edit <?= ((int)AccountInfoType === 10) ? "Department": "Group"; ?>" open-modal--html='<?php 
                                            ...
                                            require 'subpages/forms/groups.subgroups/group-edit_form.php'; 
                                        ?>' open-modal--buttons='
                                            <button class="btn btn-secondary" type="button" data-dismiss="modal">Close</button>
                                        '>
                                ...
                                function show_info_btn($group, $created_by, $TimeAgo, $updated_by, $updated_TimeAgo, $class) { ?>
                                    <button class="<?= $class; ?>" type="button" data-toggle="modal"
                                        open-modal--id="info_group-<?= $group['pdmg_id']; ?>" open-modal--title="<?= ((int)AccountInfoType === 10) ? "Department": "Group"; ?> Info"
                                        open-modal--html='<?php 
                                ...
                                function delete_btn($group_id, $account_id, $user_id, $class) { ?>
                                    <button class="<?= $class; ?>"
                                        ...
                                        btn-submit-post--confirm="Delete <?= ((int)AccountInfoType === 10) ? "Department": "Group"; ?>?"
                                        btn-submit-post--url="<?= API_BASE_URL."client-membership/group/delete"; ?>">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-12 col-md-5 col-lg-4">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body">
                                        <h5 class="card-title">Create <?= ((int)AccountInfoType === 10) ? "Department": "Group"; ?></h5>
                                        <?php require_once 'subpages/forms/groups.subgroups/group-create_form.php'; ?>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        foreach ($groups as $key => $group) { 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="white-space: nowrap;">
                                                                    ...
                                                                    <a href="<?= CLIENT_BASE_URL; ?>attendance/settings/clocking-agents-group?group-id=<?= $group['pdmg_id']; ?>&view-type=1"
