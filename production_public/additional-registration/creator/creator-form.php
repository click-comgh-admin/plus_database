<?php
    ...
    define('PAGE_DESC', "Add Additional Registration Question(s)");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'additional-registration/creator/form', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <additional-registration-creator-form email="<?= $user_info['pdcu_email']; ?>" 
