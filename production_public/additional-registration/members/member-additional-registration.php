<?php
    ...
    define('PAGE_TITLE', "Additional Registration");
    define('PAGE_DESC', "View Additional Registration Questions");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'additional-registration/members/view', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <additional-registration-member-view email="<?= $user_info['pdcu_email']; ?>" 
                            mid="<?= $user_info['pdcu_id']; ?>" clientId="<?= $user_info['pdcu_account_id']; ?>">
                        </additional-registration-member-view>
                    </div>
