<?php
    ...
    define('PAGE_TITLE', "Additional Registration Questions");
    define('PAGE_DESC', "Update Additional Registration Questions");
?>
<!doctype html>
<html lang="en">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <?php
                            ...
                            define("Current_BaseUrl", CLIENT_BASE_URL."additional-registration-questions/");
                            define("Current_BaseDir", BASE_DIRECTORY."/additional-registration-questions/");                            
                        ?>
                        <?php
                            require_once('subpages/questions/view.php');
                        ?>
                    </div>
