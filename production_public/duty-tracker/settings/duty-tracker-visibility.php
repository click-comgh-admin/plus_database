<?php
    ...
    define('PAGE_TITLE', "Duty Tracker => Settings");
    define('PAGE_DESC', "Setup Duty Tracker Visibility");
?>
<!doctype html>
<html lang="en">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <?php
                            ...
                            //     die();
                            // }
                            define("Current_BaseUrl", CLIENT_BASE_URL."duty-tracker/settings/");
                            define("Current_BaseDir", BASE_DIRECTORY."/duty-tracker/settings/");
                            
                            
                        ?>
                        <?php
                            require_once('subpages/duty_tracker_visibility/view.php');
                        ?>
                    </div>
