<?php
    ...
    define('PAGE_TITLE', "Duty Tracker => Reports");
    define('PAGE_DESC', "Duty Reports <i class=\"pe-7s-note2 p-1 font-weight-bold\"></i>");
?>
<!doctype html>
<html lang="en">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <?php
                            ...
                            //     die();
                            // }
                            define("Current_BaseUrl", CLIENT_BASE_URL."duty-tracker/reports/");
                            define("Current_BaseDir", BASE_DIRECTORY."/duty-tracker/reports/");
                            
                            
                        ?>
                        <?php
                            require_once('subpages/member-reports/supervisor-remarks-view.php');
                        ?>
                    </div>
