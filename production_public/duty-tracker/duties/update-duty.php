<?php
    ...
    define('PAGE_TITLE', "Duty Tracker => Duties");
    define('PAGE_DESC', "Information about Duty");
?>
<!doctype html>
<html lang="en">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <?php
                            ...
                            //     die();
                            // }
                            define("Current_BaseUrl", CLIENT_BASE_URL."duty-tracker/duties/");
                            define("Current_BaseDir", BASE_DIRECTORY."/duty-tracker/duties/");
                            
                            
                        ?>
                        <?php
                            require_once('subpages/update-duty/view.php');
                        ?>
                    </div>
