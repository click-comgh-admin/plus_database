<?php
    ...
    define('PAGE_TITLE', "File Manager => Folders");
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-folder icon-gradient bg-sunny-morning">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                                    ...
                                    <div class="card-body px-0">
                                                ...
                                                <div class="widget-content py-1">
                                                    <div class="widget-content-outer">
                                                        <?php
                                                            ...
                                                            $fmSpacePercent = @(int)((floatval($pdcfmf_space_used)*100)/floatval($pdcfmf_space_used));
                                        ...
                                        <?php
                                            if (isset($_GET['id']) && !empty($_GET['id'])) {
                                                require_once "subpages/folder/folder.php";
                                            } else {
                                                require_once "subpages/folder/folders.php";
                                            }
                                        ?>
                                    </div>
                                </div>
