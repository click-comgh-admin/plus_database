...
<html lang="en">
    ...
    <body>
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        ?>
                        <?php
                            require_once('subpages/employment/view.php');
                        ?>
                    </div>
        ...
        <script data-main="scripts/app" src="<?= CLIENT_BASE_URL; ?>/assets/js/@nodejs/require.js"></script>
        <script type="module" src="<?= CLIENT_BASE_URL; ?>/assets/js/@nodejs/employment/main.js"></script>
    </body>
</html>