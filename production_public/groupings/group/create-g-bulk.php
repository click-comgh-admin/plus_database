<?php
    ...
    define('PAGE_DESC', "Create Bulk Group(s)");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/groupings/group_subgroup/groups/add-bulk', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <membership-groupings-group_subgroup-group-add-bulk email="<?= $user_info['pdcu_email']; ?>" 
                            mid="<?= $user_info['pdcu_id']; ?>" clientId="<?= $user_info['pdcu_account_id']; ?>">
                        </membership-groupings-group_subgroup-group-add-bulk>
                    </div>
