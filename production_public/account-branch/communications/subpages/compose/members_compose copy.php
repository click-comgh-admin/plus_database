        ...
        <div class="btn-group-sm nav btn-group" role="group">
            <?php
                foreach ($message_types as $ms_key => $ms) { 
                    ...
                    <a class="btn-shadow btn btn-primary show <?= $active; ?>" href="#show_compose_form_<?= (int)$ms_key+1; ?>" data-toggle="tab">
        ...
        <?php
            foreach ($message_types as $ms_key => $ms) { 
                ...
                <div class="tab-pane show  <?= $active; ?> p-0" id="show_compose_form_<?= (int)$ms_key+1; ?>" role="tabpanel">
                    <?php require_once Current_BaseDir."/forms/compose/members_".$form.".php"; ?>
                </div>
            <?php }
        ?>
    </div>
