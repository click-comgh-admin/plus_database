...
?>
<div class="card-header"><i class="header-icon lnr-license icon-gradient bg-plum-plate"> <small class="small">Message To Head Office</small></i>
        ...
        <div class="btn-group-sm nav btn-group" role="group">
            <?php
                ...
                foreach ($message_types as $ms_key => $ms) { 
                    ...
                    $senderUrl = Current_BaseUrl."/branch-message?compose&send=$type"; ?>
    ...
    <div class="tab-content">
        <div class="tab-pane show active p-0" role="tabpanel">
            <?php 
                ...
                require_once Current_BaseDir."/forms/compose/clients_".$composePage.".php";
            ?>
        </div>
    </div>
</div>
