...
<form role="form" action="<?= API_BASE_URL."client-membership/branch/communications/branch/reply/email"; ?>" method="POST"
    ...
    <div class="row justify-content-center">
        ...
        <input type="hidden" name="head_office_id" value="<?= isset($is_branch_account['pdcbl_client']) ? $is_branch_account['pdcbl_client'] : 0; ?>"/>
