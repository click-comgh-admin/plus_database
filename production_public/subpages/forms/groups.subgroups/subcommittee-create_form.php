<?php
    if (isset($_POST) && !empty($_POST) && isset($_POST['create'])) {
        define("POST_URL", API_BASE_URL."client-membership/subcommittee/add");
        require_once 'subcommittee-create_form - processing.php';
    }
?>
<form role="form" action="<?= CLIENT_BASE_URL; ?>subcommittees?<?= $_SERVER['QUERY_STRING']; ?>" method="POST">
    <div class="row align-items-center justify-content-center">
        <div class="col-lg-12 col-md-12">
			...
			<?php
				$groupList = $ccApi->committees($all=true, $account_id, $id=1, function($groups) {
					$at = '';
        ...
        <div class="col-lg-12 col-md-12">
            <?php
				$tittle_placeholder = "Create New Sub-Committee";
				$id_name = "subgroup";
			?>
			<h6></h6>
            <?php
