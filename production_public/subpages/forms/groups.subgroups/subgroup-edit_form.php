<form role="form" action="<?= API_BASE_URL."client-membership/subgroup/edit"; ?>" method="POST"
    make-general-posts="<?= $confirm_msg; ?> (<?= $subgroup_name; ?>)">
    <div class="row align-items-center justify-content-center">
        <div class="col-lg-12 col-md-12">
            <?php
				$tittle_placeholder = ((int)AccountInfoType === 10) ? "Edit Unit of [".$group_name."]": "Edit Sub-Group of [".$group_name."]";
				$id_name = "subgroup";
			?>
            <h6></h6>
            <?php
