<?php
    if (isset($_POST) && !empty($_POST) && isset($_POST['create'])) {
        define("POST_URL", API_BASE_URL."client-membership/subgroup/add");
        require_once 'subgroup-create_form - processing.php';
    }
?>
<form role="form" action="<?= CLIENT_BASE_URL; ?>subgroups?<?= $_SERVER['QUERY_STRING']; ?>" method="POST">
    <div class="row align-items-center justify-content-center">
        <div class="col-lg-12 col-md-12">
			...
			<?php
				$groupList = $ccApi->groups($all=true, $account_id, $id=1, function($groups) {
					$at = '';
        ...
        <div class="col-lg-12 col-md-12">
            <?php
				$tittle_placeholder = ((int)AccountInfoType === 10) ? "Create New Unit": "Create New Sub-Group";
				$id_name = "subgroup";
			?>
			<h6></h6>
            <?php
