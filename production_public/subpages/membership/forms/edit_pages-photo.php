<?php
    if (isset($_POST) && !empty($_POST)) {
        require_once 'edit_pages-photo - processing.php';
    }
    define("POST_URL", API_BASE_URL."membership/edit/photo");
?>
<form class="container" role="form" action="<?= POST_URL; ?>" method="POST" enctype="multipart/form-data"
    ...
    <div class="row justify-content-center">
        ...
        <div>
            ...
            <input type="hidden" name="filename" value="<?= str_replace("/", "", @$member['pdm_profile_picture']); ?>" />
