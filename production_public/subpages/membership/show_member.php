                        ...
                        <div class="main-card mb-3 card shadow">
                            <div class="card-header-tab card-header-tab-animation card-header h-25">
                                <div class="card-header-title">
                                    ...
                                    <?= @$member['pdm_firstname'] . " " . @$member['pdm_surname']; ?>'s Photo
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                <h5 class="card-title mb-0"><?= @$member['pdm_firstname'] . " " . @$member['pdm_surname']; ?>
                                </h5>
                                <a class="btn-actions-pane-right btn btn-warning"
                                    href="<?= CLIENT_BASE_URL; ?>members?edit-member&member=<?= @$_GET['member']; ?>&type=photo">Edit</a>
                            </div>
                        </div>
                    </div>
                    <?php
            ...
            <div class="col-md-8 col-lg-8">
                <div class="main-card mb-3 card">
                    <div class="card-header"><i class="header-icon lnr-license icon-gradient bg-plum-plate"> </i>
                        About <?= @$member['pdm_firstname'] . " " . @$member['pdm_surname']; ?>
