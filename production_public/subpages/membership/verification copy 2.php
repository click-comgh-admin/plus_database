        ...
        <div class="main-card mb-3 card shadow">
            <div class="card-body">
                ...
                <form role="form" action="" method="POST"
                    btn-general-posts--form="Continue User Verification?" class="d-none d-lg-block table-responsive">
                    <table
                ...
                <form role="form" action="" method="POST"
                    btn-general-posts--form="Continue Member Verification?" class="d-block d-lg-none table-responsive">
                    <table
                        ...
                        <thead>
                            <tr>
                                <th>#</th>
                                <th data-orderable="false">Member Verification <hr class="mb-1 mt-0">
                                    <button type="submit" class="btn badge btn-sm px-1 btn-outline-info shadow"
                                        btn-general-posts="Continue Member Verification?"
                                        btn-general-posts--url="<?= API_BASE_URL."membership/verify-multiple"; ?>">
                                        <span class="font-weight-bold">Verify Checked</span>
                                    </button><br>
                                    <button type="submit" class="btn badge btn-sm px-1 btn-outline-danger shadow mt-1"
