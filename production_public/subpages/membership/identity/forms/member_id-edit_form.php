<form role="form" action="<?= API_BASE_URL."membership/identity/edit"; ?>" method="POST"
    make-general-posts="<?= $confirm_msg; ?> (<?= $identity_name; ?>)">
    <div class="row align-items-center justify-content-center">
        <div class="col-lg-12 col-md-12">
            <?php
				$tittle_placeholder = "Edit Member ID";
				$id_name = "member_identity";
			?>
            <h6></h6>
            <?php
                $input_value = 'value="'.$identity_name.'"';
