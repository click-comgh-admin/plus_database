<?php
    if (isset($_POST) && !empty($_POST) && isset($_POST['create'])) {
        define("POST_URL", API_BASE_URL."membership/identity/prefix_add");
        require_once 'id_prefix-create_form - processing.php';
    }
?>
<form role="form" action="<?= memberIdPrefix_BaseUrl; ?>" method="POST">
    <div class="row align-items-center justify-content-center">
        <div class="col-lg-12 col-md-12">
            <?php
				$tittle_placeholder = "Create New ID Prefix";
				$id_name = "id_prefix";
			?>
			<h6></h6>
            <?php
