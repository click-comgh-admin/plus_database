<?php
    ...
    $page_url = CLIENT_BASE_URL."appointments/$page";
            ...
            <div class="card-body">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <?php require_once BASE_DIRECTORY."/appointments/forms/filter/date_filter_form.php";?>
                    </div>
                    <div class="col-md-12 col-lg-6">
                        <?php require_once BASE_DIRECTORY."/appointments/forms/filter/group_filter_form.php";?>
                    </div>
                    <div class="col-md-12 col-lg-12"></div>
                </div>
            </div>
        ...
        <div class="main-card mb-3 card shadow">
            <div class="card-body px-2">
                ...
                <div class="d-none d-lg-block table-responsive">
                    <table class="mb-0 table table-striped" pagin_table="office_appointments" pt_c_by_date="1" pt_c_user="<?= $user_id; ?>"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="white-space: nowrap;">Extra</th>
                ...
                <div class="d-block d-lg-none table-responsive">
                    <table class="mb-0 table table-striped" pagin_table="office_appointments_sm" pt_c_by_date="1" pt_c_user="<?= $user_id; ?>"
                        pt_c_start_date="<?= $start_date; ?>" pt_c_end_date="<?= $end_date; ?>" pt_c_cid="<?= AccountInfoId; ?>" 
                        pt_c_by_appointment_status="<?= $by_appointment_status; ?>" pt_c_appointment_status="<?= $this_appointment_status; ?>" 
                        pt_c_by_group_id="<?= $by_group_id; ?>" pt_c_group_id="<?= $this_group_id; ?>">
                        <thead>
