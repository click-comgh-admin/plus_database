                    ...
                    <table class="mb-0 table table-striped" pagin_table="office_appointments_print" pt_c_by_date="1" pt_c_user="<?= $user_id; ?>"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="white-space: nowrap;" class="d-none">Meeting Agenda</th>
                                <th style="white-space: nowrap;" class="d-none">Entered By</th>
                                <th style="white-space: nowrap;" class="d-none">Entry Date</th>
                                <th style="white-space: nowrap;" class="d-none">Updated By</th>
                                <th style="white-space: nowrap;" class="d-none">Update Date</th>
                            </tr>
                        </thead>
                        <tbody>
