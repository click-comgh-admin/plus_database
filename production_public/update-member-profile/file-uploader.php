<?php
    ...
    define('PAGE_TITLE', "Form File Uploader Page");
    define('PAGE_DESC', "Form File Uploader Page");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-cloud-upload icon-gradient bg-mean-fruit">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                        ...
                        ?>
                        <?php
                            require_once('subpages/file-uploader/view.php');
                        ?>
                    </div>
