    ...
    class AddComment
    {
        ...
        { ?>
            <div class="col-lg-12 col-md-12">
                ...
                <div class="row justify-content-center">
                    <?= $this->header("Create New Comment."); ?>
                    <div class="col-lg-8 col-md-8">
                        <?php 
                            $tittle_placeholder = "Comment Details";
                            $id_name = "comment_content";
                        ?>
                        <h6><?= $tittle_placeholder; ?></h6>
                        <?php
                            $input_value = (isset($this->data['comment']["pdt_comment_content"])) 
                                ? multilineText($this->data['comment']["pdt_comment_content"]) : "";
