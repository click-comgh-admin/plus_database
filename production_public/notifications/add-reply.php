<?php
    ...
    define('PAGE_TITLE', "Notifications Comment - Reply => Add");
    define('PAGE_DESC', "Add Notification Comment - Reply");
?>
<!doctype html>
<html lang="en">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                                ...
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-bell icon-gradient bg-grow-early">
                                            <i class="pe-7s-plus icon-gradient bg-grow-early"
                                                style="font-size: 15px;position: absolute;
                                                top: 22.5px;left: 22.5px;font-weight: bold;">
                                            </i>
                                        </i>
                                    </div>
                                    <div>
                        ...
                        <?php
                            ...
                            //     die();
                            // }
                            define("Current_BaseUrl", CLIENT_BASE_URL."notifications/");
                            define("Current_BaseDir", BASE_DIRECTORY."/notifications/");                            
                        ?>
                        <?php
                            require_once('subpages/add-reply/view.php');
                        ?>
                    </div>
