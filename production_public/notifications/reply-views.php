<?php
    ...
    define('PAGE_TITLE', "Notifications - Comment Reply Views => View");
    define('PAGE_DESC', "View Notifications - Comment Reply Views");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        ?>
                        <?php
                            require_once('subpages/reply-views/view.php');
                        ?>
                    </div>
