        ...
        <div class="main-card mb-3 card shadow">
            <div class="card-body px-2">
                <?php
                    ...
                    // print_r($reply);
                    foreach ($reply as $key => $n) {
                        $client_name = isset($n['client_info']['name'])
                            ? $n['client_info']['name']: "";

                        $replier_fname = isset($n['replier']['firstname']) 
                            ? $n['replier']['firstname']: "";

                        $replier_lname = isset($n['replier']['surname']) 
                            ? $n['replier']['surname']: "";

                        $replier_name = "$replier_fname $replier_lname";

                        $date = isset($n['date']['date']) ? getDateTimeAgo($n['date']['date']): "";

                        $date = isset($date['timeAgo'])? $date['timeAgo']: "";
                        
                        $photo = isset($n['replier']['profile_picture']) ? $n['replier']['profile_picture']: ""; 
                        
                        $content = isset($n['reply']) ? $n['reply']: "";
                        ...
                        $indicators = "";
                        $attachmentDisplay = "";
                        $indicatorId = "reply-{$n['id']}-Indicators";
