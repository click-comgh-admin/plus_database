<?php
require_once Current_BaseDir."subpages/comment-views/setup.php";
...
$repliesUrl = ClientBaseUrl . "notifications/view-replies?notification={$notification_id}&comment={$comment_id}";
require_once Current_BaseDir."subpages/comment-views/comment.php";
            ...
            <div class="card-body px-2">
                ...
                <div class="table-responsive">
                    <table class="mb-0 table table-striped table-hover" pagin_table="client-notifications-ncr_views"
                        ...
                        pt_c_file="<?= FILE_BUCKET_BASE_URL; ?>" pt_c_by_comment_id="1"
                        pt_c_comment_id="<?= $comment_id;?>" pt_c_by_notification_id="0"
                        pt_c_notification_id="0" pt_c_by_comment_reply_id="0"
