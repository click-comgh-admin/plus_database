<?php
    ...
    define('PAGE_TITLE', "School Pickup");
    define('PAGE_DESC', "View School Pickup Info");
?>
<!doctype html>
<html lang="en">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <?php
                            ...
                            $get_string = "pick-up/school-pickup?client_id=$account_id&member_id=$member_id";
                            ...
                            function delete_btn($pickup_id, $member_id, $account_id, $user_id, $class) { ?>
                                <button class="<?= $class; ?>"
                                    ...
                                    btn-submit-post--url="<?= API_BASE_URL."school/clients/pick-up/delete_school_pickup"; ?>">
                                ...
                                <div class="main-card mb-3 card shadow">
                                    <?php
                                        if (is_array($pickupInfo)) {
                                            ...
                                            require_once 'subpages/school_pickup.php';
                                        } else { ?>
                                            <div class="card-body">
