<?php
    if (isset($_POST) && !empty($_POST)) {
        define("POST_URL", API_BASE_URL."school/clients/pick-up/add_home_pickup");
        require_once 'home-create_form - processing.php';
    }
?>
<form role="form" action="<?= schoolPickup_BaseUrl; ?>home-pickup?<?= $_SERVER['QUERY_STRING']; ?>" method="POST">
