<?php
    ...
    $get_string = "subject/student?client_id=$account_id&member_id=$member_id";
        ...
        <div class="card-header"><i class="header-icon lnr-license icon-gradient bg-plum-plate"> </i>
            <div class="btn-actions-pane-right">
                <div class="btn-group-sm nav btn-group" role="group">
                    <a class="btn-shadow btn btn-info show active" href="#subject_data_info_tab" data-toggle="tab">Subjects</a>
                    <a class="btn-shadow btn btn-success" href="<?= schoolStudent_BaseUrl; ?>">Reset Data</a>
                    <a class="btn-shadow btn btn-warning show <?= (isset($_POST['add-form']) && ($_POST['add-form'] == "edit_subject_data")) ? " active" : ""; ?>" href="#edit_subject_data_tab" data-toggle="tab">Upload Subjects</a>
                </div>
            </div>
        </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <th>
                                                                            ...
                                                                            <?php /* edit_btn($fee, $account_id, $user_id, "Edit This Subject Record", "btn btn-sm m-1 btn-warning shadow", $tf=$tf, $type = "sm");*/ ?>
                                                                            <?php 
                                                                                $fee_id = $fee['pdsc_id']; 
