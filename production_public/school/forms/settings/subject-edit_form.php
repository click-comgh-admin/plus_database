<form role="form" action="<?= API_BASE_URL."school/clients/subject/edit"; ?>" method="POST"
    make-general-posts="<?= $confirm_msg; ?> (<?= $subject_name; ?>)">
    <div class="row align-items-center justify-content-center">
        <div class="col-lg-12 col-md-12">
            <?php
				$tittle_placeholder = "Edit Subject";
				$id_name = "subject";
			?>
            <h6></h6>
            <?php
                $input_value = 'value="'.$subject_name.'"';
