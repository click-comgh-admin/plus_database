<?php
    if (isset($_POST) && !empty($_POST) && isset($_POST['create'])) {
        define("POST_URL", API_BASE_URL."school/clients/class/subclass/add");
        require_once 'subclass-create_form - processing.php';
    }
?>
<form role="form" action="<?= school_BaseUrl; ?>subclass?<?= $_SERVER['QUERY_STRING']; ?>" method="POST">
    <div class="row align-items-center justify-content-center">
        ...
        <div class="col-lg-12 col-md-12">
            <?php
				$tittle_placeholder = "Create New Sub-Class";
				$id_name = "subclass";
			?>
			<h6></h6>
            <?php
