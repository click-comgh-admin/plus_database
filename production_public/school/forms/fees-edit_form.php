<form role="form" action="<?= API_BASE_URL."school/clients/class/edit"; ?>" method="POST"
    make-general-posts="<?= $confirm_msg; ?> (<?= $fee_name; ?>)">
    <div class="row align-items-center justify-content-center">
        <div class="col-lg-12 col-md-12">
            <?php
				$tittle_placeholder = "Edit Fee Record";
				$id_name = "fee";
			?>
            <h6></h6>
            <?php
                $input_value = 'value="'.$fee_name.'"';
