<?php
    if (isset($_POST) && !empty($_POST)) {
        if (isset($_POST['add-form']) && $_POST['add-form'] == "new-form") {
            define("POST_URL", API_BASE_URL."custom-form/clients/form/add");
            require_once 'add_new_form - processing.php';
        }
    }
?>
<form role="form" action="<?= customForms_BaseUrl . "create-form?" . $_SERVER['QUERY_STRING']; ?>" method="POST" enctype="multipart/form-data">
    <div class="row justify-content-center">
        <input type="hidden" name="add-form" value="new-form" />
        <div class="col-md-12">
            <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12 col-md-12">
                    <button type="submit" class="btn btn-sm bg-night-sky text-light btn-block font-weight-bold rounded-pill">Add New Form</button>
                </div>
            </div>
        </div>
    </div>
