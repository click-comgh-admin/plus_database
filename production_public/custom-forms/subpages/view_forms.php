                                                    ...
                                                    <td>
                                                        <div class="container">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <a href="<?= customForms_BaseUrl; ?>questions/create-form?form=<?= $form['pdcqq_id']; ?>" class="btn my-1 btn-success btn-sm w-100" form="button">
                                                                        Open <span class="ml-1 pe-7s-link"></span>
                                                                    </a>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <a href="<?= customForms_BaseUrl; ?>create-form?edit=<?= $form['pdcqq_id']; ?>" class="btn my-1 btn-warning btn-sm w-100" form="button">
