<?php
    ...
    define('PAGE_TITLE', "Custom Forms => Create Form(s)");
    define('PAGE_DESC', "Create Form(s)");
?>
<!doctype html>
<html lang="en">
                                        ...
                                        <div class="main-card mb-3 card shadow">
                                            <div class="card-header-tab card-header-tab-animation card-header h-25">
                                                <div class="card-header-title">
                                                    <i class="header-icon lnr-apartment icon-gradient bg-sunny-morning"> </i>Add Form
                                                </div>
                                            </div>
                                            <div class="card-body py-0">
                                                <div class="collapse <?= (isset($_POST['add-form']) && ($_POST['add-form'] == "new-form"))? "show": ""; ?> py-2" id="add_new_form">
                                                    <?php require_once "forms/add_new_form.php"; ?>
                                                </div>
                                            </div>
                                            <div class="card-footer">
                                                <?php
                                                    if (isset($_POST['add-form'])) {
                                                        if ($_POST['add-form'] == "new-form") { ?>
                                                            <button class="btn-actions-pane-right btn btn-primary" aria-expanded="true"
                                                                type="button" data-toggle="collapse" href="#add_new_form">Add Form</button>
                                                        <?php } else { ?>
                            ...
                            <?php
                                if (isset($_GET['edit'])) {
                                    if (isset($_GET['edit']) && !empty($_GET['edit'])) {
                                        require_once "subpages/edit_form.php";
                                    } else {
                                        require_once "subpages/view_forms.php";
                                    }
                                } else {
                                    require_once "subpages/view_forms.php";
                                }
