<?php
    $get_string = "mailer/peers/contact_mail?account_id=$account_id&user_id=$user_id";
    ...
    <?php
        foreach ($messages as $key => $message) { 
            ...
            if ($sender_id != $user_id) {
                ...
                <a class="list-group-item" email-tabs="container-list--item" href="peers?show=<?= $message['pdccmc_thread_id'] == 0
                    ? $message['pdccmc_id']: $message['pdccmc_thread_id']; ?>#<?= $message['pdccmc_id']; ?>">
