<?php
    ...
    $get_string = "mailer/customer-care/one_contact_mail?account_id=$account_id&user_id=$user_id&message_id=".$_GET['show'];
    ...
    <?php die(); }
    $get_string = "mailer/customer-care/contact_mail_trail?account_id=$account_id";
