<?php
    ...
    define('PAGE_TITLE', "Credit");
    define('PAGE_DESC', "Buy & View Credit Usage.");
?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-wallet icon-gradient bg-happy-green">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-12 col-lg-4">
                                <?php require_once "subpages/credit/buy_credit.php"; ?>
                            </div>
                            <div class="col-md-12 col-lg-8">
                                <?php require_once 'subpages/credits.php'; ?>
                            </div>
                        </div>
                    </div>
