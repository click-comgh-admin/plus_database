<?php
    ...
    define('PAGE_TITLE', "Contact Agent(s) => View/Assign Agent Groups");
    define('PAGE_DESC', "View/Assign Agent Groups");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        ?>
                        <?php
                            require_once('subpages/contact-agent/view_agent_group.php');
                        ?>
                    </div>
