<?php
    ...
    define('PAGE_TITLE', "Contact Agent(s) => View/Assign Agent Contacts");
    define('PAGE_DESC', "View/Assign Agent Contacts");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        ?>
                        <?php
                            require_once('subpages/contact-agent/view_agent_contacts.php');
                        ?>
                    </div>
