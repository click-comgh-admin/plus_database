<?php
    ...
    define('PAGE_TITLE', "Contact Access Codes => Get Code To Connect To Nstacom");
    define('PAGE_DESC', "Get Code To Connect To Nstacom");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        ?>
                        <?php
                            require_once('subpages/connect-to-nstacom/view.php');
                        ?>
                    </div>
