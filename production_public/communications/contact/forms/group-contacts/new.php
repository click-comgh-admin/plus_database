...
<!-- <form upload_attachment="this-form" role="form" action="<?= API_BASE_URL."communications/clients/contacts/groups/new-contact"; ?>" method="POST"
    make-general-posts="Save Contact? <span class=d-none>(individual)"> -->
<form upload_attachment="this-form" role="form" action="<?= CLIENT_BASE_URL."/assets/php/custom/fetch_reply.php?fetch=form-post&url=communications/clients/contacts/groups/new-contact"; ?>" method="POST"
    make-general-posts="Save Contact? <span class=d-none>(individual)">
