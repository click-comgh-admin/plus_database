<?php
    ...
    define('PAGE_TITLE', "Contact Book");
    define('PAGE_DESC', "Send & View Messages From Contacts.");
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-phone icon-gradient bg-midnight-bloom">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-12 col-lg-12">
                                        <?php
                                            ...
                                            $input_attributes = ''.$input_value.' name="'.$id_name.'" id="'.$id_name.'" comms-search--at=""
                                            comms-search="'.CLIENT_BASE_URL.'communications/contacts" comms-search--aid="'.$account_id.'"
                            ...
                            <div class="col-md-12 col-lg-8">
                                <div class="mb-3 card shadow">
                                                ...
                                                <div class="<?= $type; ?>">
                                                    <div class="btn-actions-pane-right">
                                                        <button class="<?= $class; ?> mx-1" style="padding: .25rem .5rem !important"
                                                            ...
                                                            btn-submit-multiple--url="<?= API_BASE_URL."communications/clients/mailer/delete"; ?>">
                                    ...
                                    <div class="card-body <?= ($_SERVER['QUERY_STRING'] == "outbox")?"scroll-area-xl": "";?>" email-tabs="container">
                                        <?php 
                                            if (isset($_GET['inbox'])) {
                                                require_once 'subpages/inbox/contacts_inbox.php';
                                            } else if (isset($_GET['outbox'])) {
                                                require_once 'subpages/outbox/contacts_outbox.php';
                                            } else if (isset($_GET['compose'])) {
                                                require_once 'subpages/compose/contacts_compose.php';
                                            } else if (isset($_GET['show'])) {
                                                if (isset($_GET['reply'])) {
                                                    require_once 'subpages/compose/contacts_compose_reply.php';
                                                } else {
                                                    require_once 'subpages/show/contacts_show.php';
                                                }
                                            } else {
                                                require_once 'subpages/inbox/contacts_inbox.php';
                                            }
