<form upload_file="multiple" method="POST" action="<?= API_BASE_URL."mail-attachment/"; ?>"
...
<form role="form" action="<?= API_BASE_URL."communications/clients/mailer/customer-care/email"; ?>" method="POST"
