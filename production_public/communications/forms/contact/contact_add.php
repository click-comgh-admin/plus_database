<?php
    if (isset($_POST) && !empty($_POST)) {
        if (isset($_POST['add-contact-form-type']) && ($_POST["add-contact-form-type"] == "individual")) {
            define("POST_URL", API_BASE_URL."communications/clients/contacts/add");
            require_once 'contact_add - processing.php';
        }
    }
?>
<form role="form" action="<?= ComBaseUrlAlt . "?" . $_SERVER['QUERY_STRING']; ?>" method="POST" enctype="multipart/form-data" make-gen eral-posts="Update Contact?">
    <div class="row justify-content-center">
        ...
        <input type="hidden" name="add-contact-form-type" value="individual" />
        <div class="col-md-12">
            <div class="row justify-content-center">
                <div class="col-lg-12 col-md-12">
                    ...
                    <?php
                        $input_value = (isset($_POST['contact_name'])) ? $_POST['contact_name'] : null;
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <h6><?= $tittle_placeholder; ?></h6>
                    <?php
                        $input_value = (isset($_POST['contact_phone'])) ? $_POST['contact_phone'] : null;
        ...
        <div class="col-md-12" select-show="country_of_contact">
            ...
            <div class="card-footer">
                <button class="btn-actions-pane-right btn btn-primary" aria-expanded="true"
                    type="button" data-toggle="collapse" href="#add_contact_location_data">Add Location Data</button>
            </div>
        </div>
        <div class="col-md-12">
            <div class="row justify-content-center">
                <div class="col-lg-12 col-md-12">
                    ...
                    <h6><?= $tittle_placeholder; ?></h6>
                    <?php
                        $input_value = (isset($_POST['contact_info'])) ? $_POST['contact_info'] : "";
