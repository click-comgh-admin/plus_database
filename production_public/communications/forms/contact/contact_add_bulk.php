<?php
    if (isset($_POST) && !empty($_POST)) {
        if (isset($_POST['add-contact-form-type']) && ($_POST["add-contact-form-type"] == "bulk")) {
            define("POST_URL", API_BASE_URL."communications/clients/contacts/bulk");
...
<form role="form" action="<?= ComBaseUrlAlt . "?" . $_SERVER['QUERY_STRING']; ?>" method="POST" enctype="multipart/form-data" make-gen eral-posts="Update Contact?">
    <div class="row justify-content-center">
        ...
        <input type="hidden" name="add-contact-form-type" value="bulk" />
        <div class="col-md-12">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12 col-md-12">
                    <?php 
                        ...
                        $id_name = "country_of_contact_bulk";
                    ?>
                    <?php
        ...
        <div class="col-md-12" select-show="country_of_contact_bulk">
