<?php
    if (isset($_POST) && !empty($_POST)) {
        if (isset($_POST['add-contact-form-type']) && ($_POST["add-contact-form-type"] == "individual-group")) {
            define("POST_URL", API_BASE_URL."communications/clients/contacts/group/add");
...
<form role="form" action="<?= ComBaseUrlAlt . "?" . $_SERVER['QUERY_STRING']; ?>" method="POST" enctype="multipart/form-data" make-gen eral-posts="Update Contact?">
    <div class="row justify-content-center">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12 col-md-12">
                    <?php 
                        ...
                        $id_name = "country_of_contact_group";
                    ?>
                    <?php
        ...
        <div class="col-md-12" select-show="country_of_contact_group">
            ...
            <div class="card-body p-0">
                <div class="collapse py-2" id="add_contact_location_data_group">
                    <div class="row justify-content-center">
                        <?php require "contact_location_details_group.php"; ?>
                    </div>
                </div>
            </div>
