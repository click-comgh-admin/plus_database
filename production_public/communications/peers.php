<?php
    ...
    define('PAGE_TITLE', "Peers");
    define('PAGE_DESC', "Message Other Administrative Members.");
?>
<!doctype html>
<html lang="en">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-id icon-gradient bg-asteroid">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                        ...
                        <?php
                            ...
                            define("PP_BaseUrl", CLIENT_BASE_URL."communications/peers");  
                        ?>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-12 col-lg-12">
                                        <?php
                                            ...
                                            $input_attributes = ''.$input_value.' name="'.$id_name.'" id="'.$id_name.'" comms-search--at="peers"
                                                comms-search="'.PP_BaseUrl.'" comms-search--aid="'.$account_id.'" comms-search--uid="'.$user_id.'"
                            ...
                            <div class="col-md-12 col-lg-8">
                                <div class="mb-3 card shadow">
                                                ...
                                                <div class="<?= $type; ?>">
                                                    <div class="btn-actions-pane-right">
                                                        <button class="<?= $class; ?> mx-1" style="padding: .25rem .5rem !important"
                                                            ...
                                                            btn-submit-multiple--url="<?= API_BASE_URL."communications/clients/mailer/peers/delete"; ?>">
                                    ...
                                    <div class="card-body" email-tabs="container">
                                        <?php 
                                            if (isset($_GET['inbox'])) {
                                                require_once 'subpages/inbox/peers_inbox.php';
                                            } else if (isset($_GET['outbox'])) {
                                                require_once 'subpages/outbox/peers_outbox.php';
                                            } else if (isset($_GET['messages'])) {
                                                require_once 'subpages/inbox/peers_messages.php';
                                            } else if (isset($_GET['compose'])) {
                                                require_once 'subpages/compose/peers_compose.php';
                                            } else if (isset($_GET['show'])) {
                                                if (isset($_GET['reply'])) {
                                                    require_once 'subpages/compose/peers_compose_reply.php';
                                                } else {
                                                    require_once 'subpages/show/peers_show.php';
                                                }
                                            } else {
                                                require_once 'subpages/inbox/peers_messages.php';
                                            }
