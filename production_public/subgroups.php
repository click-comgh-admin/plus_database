<?php
    ...
    if (AccountInfoCategory === 10) {
        define('PAGE_TITLE', "Units");
        define('PAGE_DESC', "View All Units Belonging To Created Departments");
    } else {
        define('PAGE_TITLE', "Sub-Groups");
        define('PAGE_DESC', "View All Sub-Groups Belonging To Created Groups.");
    }
?>
<!doctype html>
<html lang="en">
                        ...
                        <?php
                                    ...
                                    <a href="#" data-toggle="modal" open-modal--id="subgroups-<?= $group['pdmg_id']; ?>"
                                        open-modal--title="<?= $group['pdmg_group']; ?> <?= ((int)AccountInfoType === 10) ? "Units": "Sub-Groups"; ?>" open-modal--html='<?php 
                                            ...
                                            if (!empty($subgroups)) {
                                                ...
                                                echo "No ".((int)AccountInfoType === 10) ? "Unit(s)": "Sub-Group(s)"." Created";
                                            }
                                        ?>' open-modal--buttons='
                                ...
                                function edit_btn($group, $subgroup, $account_id, $user_id, $confirm_msg, $class, $tf, $type = "md") { ?>
                                    <button class="<?= $class; ?>" type="button" data-toggle="modal"
                                        ...
                                        open-modal--title="Edit <?= ((int)AccountInfoType === 10) ? "Unit": "Sub-Group"; ?> of [<?= $group['pdmg_group']; ?>]" open-modal--html='<?php 
                                            $group_id = $group['pdmg_id']; 
                                            $group_name = $group['pdmg_group']; 
                                            $subgroup_id = $subgroup['pdmg_id']; 
                                            $subgroup_name = $subgroup['pdmg_subgroup']; 
                                            require 'subpages/forms/groups.subgroups/subgroup-edit_form.php'; 
                                        ?>' open-modal--buttons='
                                            <button class="btn btn-secondary" type="button" data-dismiss="modal">Close</button>
                                        '>
                                ...
                                function show_info_btn($group, $group_TimeAgo, $group_created_by, $group_updated_TimeAgo, $group_updated_by, $subgroup, $created_by, $updated_TimeAgo, $updated_by, $TimeAgo, $class) { ?>
                                    <button class="<?= $class; ?>" type="button" data-toggle="modal"
                                        open-modal--id="info_subgroup-<?= $group['pdmg_id']; ?>-<?= $subgroup['pdmg_id']; ?>" open-modal--title="<?= ((int)AccountInfoType === 10) ? "Unit": "Sub-Group"; ?> Info"
                                        open-modal--html='<?php 
                                ...
                                function delete_btn($group_id, $subgroup_id, $account_id, $user_id, $class) { ?>
                                    <button class="<?= $class; ?>"
                                        ...
                                        btn-submit-post--confirm="Delete <?= ((int)AccountInfoType === 10) ? "Unit": "Sub-Group"; ?>?"
                                        btn-submit-post--url="<?= API_BASE_URL."client-membership/subgroup/delete"; ?>">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-12 col-md-5 col-lg-4">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body">
                                        <h5 class="card-title">Create <?= ((int)AccountInfoType === 10) ? "Unit": "Sub-Group"; ?></h5>
                                        <?php require_once 'subpages/forms/groups.subgroups/subgroup-create_form.php'; ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-7 col-lg-8">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body">
                                        <h5 class="card-title"><?= ((int)AccountInfoType === 10) ? "Units": "Sub-Groups"; ?></h5>
                                        <div class="d-none d-lg-block table-responsive">
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th style="white-space: nowrap;"><?= ((int)AccountInfoType === 10) ? "Department": "Group"; ?></th>
                                                        <th style="white-space: nowrap;"><?= ((int)AccountInfoType === 10) ? "Unit": "Sub-Group"; ?></th>
                                                            ...
                                                            foreach ($subgroups as $key => $subgroup) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="white-space: nowrap">
                                                                        ...
                                                                        <a href="<?= CLIENT_BASE_URL; ?>attendance/settings/clocking-agents-subgroup?subgroup-id=<?= $subgroup['pdmg_id']; ?>&view-type=1"
