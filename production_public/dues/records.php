<?php
    ...
    define('PAGE_TITLE', "Dues => Records");
    define('PAGE_DESC', "View Due(s) Payment Records & Make Payments");
?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="app-main__inner">
                        ...
                        <?php
                            ...
                            foreach ($appPages as $key => $page) {
                                if ((string)strtolower($page['pdpc_page']) === "dues") {
                        ...
                        <div class="row justify-content-center">
                            ...
                            <?php
                                if (isset($_GET['dues'])) {
                                    if (isset($_GET['dues']) && !empty($_GET['dues'])) {
                                        if (isset($_GET['member']) && !empty($_GET['member'])) {
                                            require_once "subpages/records/dues_record_edit.php";
                                        } else if (isset($_GET['message']) && !empty($_GET['message'])) {
                                            if (strtolower($_GET['message']) == "unpaid") {
                                                require_once "subpages/records/dues_record_message_unpaid.php";
                                            } else {
                                                require_once "subpages/records/dues_record_message_filtered.php";
                                            }
                                        } else if (isset($_GET['make_payment'])) {
                                            require_once "subpages/records/dues_record_make_payment.php";
                                        } else {
                                            require_once "subpages/records/dues_records.php";
                                        }
                                    } else {
                                        require_once "subpages/records/dues_records_view.php";
                                    }
                                } else {
                                    require_once "subpages/records/dues_records_view.php";
                                }
