<?php
    ...
    define('PAGE_TITLE', "Dues => Assign Member(s)");
    define('PAGE_DESC', "View & Assign Member(s) To Due(s)");
?>
<!doctype html>
<html lang="en">
                            ...
                            <?php
                                if (isset($_GET['dues'])) {
                                    if (isset($_GET['dues']) && !empty($_GET['dues'])) {
                                        require_once "subpages/dues_members.php";
                                    } else {
                                        require_once "subpages/dues_members_view.php";
                                    }
                                } else {
                                    require_once "subpages/dues_members_view.php";
                                }
