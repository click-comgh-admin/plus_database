<?php
    ...
    define('PAGE_TITLE', "Dues => Bulk Payments");
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="pe-7s-cash icon-gradient bg-love-kiss">
                                        </i>
                                    </div>
                                    <div>
                                        <?= PAGE_TITLE; ?>
                                ...
                                if (isset($_GET['dues'])) {
                                    if (isset($_GET['dues']) && !empty($_GET['dues'])) {
                                        if (isset($_GET['member']) && !empty($_GET['member'])) {
                                            require_once "subpages/bulk/dues_record_edit.php";
                                        } else {
                                            require_once "subpages/bulk/dues_records.php";
                                        }
                                    } else {
                                        require_once "subpages/bulk/dues_records_view.php";
                                    }
                                } else {
                                    require_once "subpages/bulk/dues_records_view.php";
                                }
