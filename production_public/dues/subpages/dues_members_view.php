                                        ...
                                        <?php
                                            foreach ($types as $type_key => $type) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= dues_BaseUrl; ?>assign-members?dues=<?= $type['pddt_id']; ?>" class="btn btn-info btn-block btn-sm" type="button">
                                                            <span class="font-weight-bold">Assign Members to <?= $type['pddt_type']; ?></span>
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php }
