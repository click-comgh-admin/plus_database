<?php
    ...
    define('PAGE_TITLE', "Members -> Statuses");
    define('PAGE_DESC', "View members by assigned status");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/members/all', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <pdb-membership-members></pdb-membership-members>
                                    </div>
                                </div>
                            </div>
                        </div>
