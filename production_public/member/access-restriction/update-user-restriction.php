<?php
    ...
    define('PAGE_TITLE', "Access Restriction -> Update User Restrictions");
    define('PAGE_DESC', "View Update User Restrictions");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/access_restriction/select_restriction/update', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <membership-access_restriction-update email="<?= $user_info['pdcu_email']; ?>" 
                                            mid="<?= $user_info['pdcu_id']; ?>" clientId="<?= $user_info['pdcu_account_id']; ?>">
                                        </membership-access_restriction-update>
                                    </div>
                                </div>
                            </div>
                        </div>
