<?php
    ...
    define('PAGE_DESC', "Update Member Info");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/members/edit', prefix: IN_PRODUCTION_MODE_PREFIX)
    );

    define("_Webpack_Pack_2", Get_Webpack_Tags(
...
<html lang="en">
    <?php 
        ...
        $cssFiles = '';
        foreach (_Webpack_Pack_2['css'] as $key => $cssFile) {
            $cssFiles .= $cssFile;
        }
    ...
    <body>
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="main-card mb-3 card shadow">
                                    <div class="card-body px-2">
                                        <?php require_once BASE_DIRECTORY . '/update-member-profile/subpages/member-account/view-new.php' ?>
                                        <!-- <pdb-membership-edit></pdb-membership-edit> -->
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <?php 
            ...
            foreach (_Webpack_Pack_2['js'] as $key => $jsFile) {
                $jsFiles .= $jsFile;
            }
