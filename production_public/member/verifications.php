<?php
    ...
    define('PAGE_TITLE', "Members -> Members");
    define('PAGE_DESC', "View Verifications");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/verification/individuals', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <pdb-membership-individual-verification></pdb-membership-individual-verification>
                    </div>
