<?php
    ...
    define('PAGE_DESC', "Add Connection Member(s)");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/connections/connection-add', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <pdb-connections-account-add></pdb-connections-account-add>
                    </div>
