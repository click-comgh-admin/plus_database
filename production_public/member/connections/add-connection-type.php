<?php
    ...
    define('PAGE_DESC', "Create Connection Types");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/connections/type-add', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <pdb-connections-type-add></pdb-connections-type-add>
                    </div>
