<?php
    ...
    define('PAGE_DESC', "View Rejected Connections");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/connections/rejected', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <pdb-connections-rejected-connections></pdb-connections-rejected-connections>
                    </div>
