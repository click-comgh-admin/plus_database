<?php
    ...
    define('PAGE_DESC', "View Organization Info");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/members/member-organization', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <pdb-membership-member-organization></pdb-membership-member-organization>
                    </div>
