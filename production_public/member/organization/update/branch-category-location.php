<?php
    ...
    define('PAGE_DESC', "Update Extra Data");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/members/edit/organization/branch-category-status-location', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <pdb-membership-update-organization-branch-category-location></pdb-membership-update-organization-branch-category-location>
                    </div>
