<?php
    ...
    define('PAGE_TITLE', "Members -> Organization");
    define('PAGE_DESC', "View Verifications");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/verification/organizations', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <pdb-membership-organization-verification></pdb-membership-organization-verification>
                    </div>
