<?php
    ...
    define('PAGE_DESC', "Update Member Bio-Data");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/members/edit/individual/bio-data', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <pdb-membership-update-bio-data></pdb-membership-update-bio-data>
                    </div>
