<?php
    ...
    define('PAGE_TITLE', "Members -> Update");
    define('PAGE_DESC', "Update Member Extra Data");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/members/edit/individual/branch-category-status-location', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <pdb-membership-update-branch-category-status-location></pdb-membership-update-branch-category-status-location>
                    </div>
