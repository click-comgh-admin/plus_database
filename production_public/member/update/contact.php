<?php
    ...
    define('PAGE_DESC', "Update Member Contact Data");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'membership/members/edit/individual/contact', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <pdb-membership-update-contact></pdb-membership-update-contact>
                    </div>
