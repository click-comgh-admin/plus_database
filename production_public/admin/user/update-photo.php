<?php
    ...
    define('PAGE_DESC', "Update User Photo");

    define("_Webpack_Pack_", Get_Webpack_Tags(
        'admin/user/edit_photo', prefix: IN_PRODUCTION_MODE_PREFIX)
    );
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <pdb-admin-user-edit-photo-form page_type="not-mine"></pdb-admin-user-edit-photo-form>
                    </div>
