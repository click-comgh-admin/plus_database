                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-center p-0 m-0" upload-preview-crop--preview="profile-picture">
                            <img class="container img-fluid" src="<?= FILE_BUCKET_BASE_URL; ?>files/clients/profile-picture/<?= @$client_user['pdcu_profile_picture']; ?>"/>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-10">
                                <?php require_once(BASE_DIRECTORY."/account/forms/account/edit/edit_pages-main-alt.php"); ?>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer d-block">
