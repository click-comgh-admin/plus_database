<?php
    ...
    define('PAGE_TITLE', "Accounts Settings");
    define('PAGE_DESC', "View & Update Account Settings");
?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="app-main__inner">
                        ...
                        <?php
                            if (isset($_GET['page']) && !empty($_GET['page'])) {
                                require_once "subpages/account/settings_pages.php";
                            } else if (isset($_GET['add'])) {
                                require_once "subpages/account/accounts_add.php";
                            } else {
                                if (isset($_GET['user']) && !empty($_GET['user'])) {
                                    require_once "subpages/account/accounts_view_user.php";
                                } else {
                                    require_once "subpages/account/accounts_view.php";
                                }
                            }
                        ?>
                    </div>
