<?php
    ...
    define('PAGE_TITLE', "Accounts Settings => Logo");
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <?php
                            if (isset($_GET['edit'])) {
                                require_once BASE_DIRECTORY."/account/subpages/settings/logo_edit.php";
                            } else {
                                require_once BASE_DIRECTORY."/account/subpages/settings/logo_view.php";
                            }
                        ?>
                    </div>
