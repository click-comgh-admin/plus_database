<?php
    ...
    define('PAGE_TITLE', "Accounts Status Indicator");
    define('PAGE_DESC', "View & Update Account Status Indicator");
?>
<!doctype html>
<html lang="en">
            ...
            <div class="app-main">
                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <?php
                            // if (isset($_GET['edit'])) {
                                // require_once BASE_DIRECTORY."/account/subpages/settings/main_settings_edit.php";
                            // } else {
                                $get_string = "active_status/client-indicator?client_id=".AccountInfoId;
                                $status_indicator = $ccApi->fetch_from($get_string, function($status_indicator)
                                {
                                    return isset($status_indicator[0])? $status_indicator[0]: [];
                                }, $debug = false);
                                require_once BASE_DIRECTORY."/account/subpages/settings/status_indicator_view.php";
                            // }
                        ?>
                    </div>
