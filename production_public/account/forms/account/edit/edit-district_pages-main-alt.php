<form role="form" action="<?= API_BASE_URL; ?>client-membership/user/edit-district-alt" click-com-wizard="form-container">
        ...
        <div class="pb-0" click-com-wizard-title="Extra" click-com-wizard="step">
            ...
            <div class="row align-items-center justify-content-center">
				<div class="col-lg-6">
					...
					<h6><?= $tittle_placeholder; ?></h6>
                    <?php
                        $set_staff_status = @$client_user['pdcu_role'];
				...
				<div class="col-lg-6">
					...
					<h6><?= $tittle_placeholder; ?></h6>
					<?php
						$set_groups = isset($client_user['user_info']['pdcud_group'])?$client_user['user_info']['pdcud_group']:"";
				...
				<div class="col-lg-6">
					...
					<h6><?= $tittle_placeholder; ?></h6>
					<?php
                        $set_subgroups = @isset($client_user['user_info']['pdcud_subgroup'])?$client_user['user_info']['pdcud_subgroup']:"";
                ...
                <div class="col-lg-6" <?= $_committee_shower; ?> select-show="<?= $id_name_changer; ?>" 
					...
					<h6><?= $tittle_placeholder; ?></h6>
                    <?php
						$set_committees = isset($client_user['user_info']['pdcud_committee'])?$client_user['user_info']['pdcud_committee']:"";
                ...
                <div class="col-lg-6" <?= $_subcommittee_shower; ?> select-show="<?= $id_name_changer; ?>" 
					...
					<h6><?= $tittle_placeholder; ?></h6>
					<?php
						$set_subcommittees = isset($client_user['user_info']['pdcud_subcommittee'])?$client_user['user_info']['pdcud_subcommittee']:"";
                ...
                <div class="col-lg-6" <?= $_appointmentstatus_shower; ?> select-show="<?= $id_name_changer; ?>"  select-show-alt--1="<?= $id_name_changer; ?>">
					...
					<h6><?= $tittle_placeholder; ?></h6>
					<?php
						$set_user_status = @isset($client_user['user_info']['pdcud_appointement_status'])?$client_user['user_info']['pdcud_appointement_status']:"";
                ...
                <div class="col-lg-6" <?= $_appointmenttermserved_shower; ?> select-show="<?= $id_name_changer; ?>"  select-show-alt--1="<?= $id_name_changer; ?>">
					...
					<h6><?= $tittle_placeholder; ?></h6>
					<?php
						$set_termserved = @isset($client_user['user_info']['pdcud_terms_served'])?$client_user['user_info']['pdcud_terms_served']: "";
                ...
                <div class="col-lg-6" <?= $_appointmentyear_shower; ?> select-show="<?= $id_name_changer; ?>"  select-show-alt--1="<?= $id_name_changer; ?>">
					...
					<h6><?= $tittle_placeholder; ?></h6>
					<?php
						$set_last_appointment_year = @isset($client_user['user_info']['pdcud_last_appointment_year'])? $client_user['user_info']['pdcud_last_appointment_year']:"";
