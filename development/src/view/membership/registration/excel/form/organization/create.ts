...
import { POST_MembershipRegisterOrganizationExcel } from '@@addons/network/members/membership/registration/excel/organization/post';
import './instructions';

@customElement("membership-registration-excel-organization-create")
export class MembershipRegistrationExcelOrganizationCreate extends LitElement {
  constructor() { super(); }
  ...
  async submitForm(e: PointerEvent) {
    e.preventDefault();
    await POST_MembershipRegisterOrganizationExcel();
  }
