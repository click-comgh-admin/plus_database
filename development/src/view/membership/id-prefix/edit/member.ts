...
import { PUT_MemberIdPrefix } from '@@addons/network/members/id_prefix/member/put';
import { MembershipMemberIDPrefixModel } from '@@addons/interfaces/members/id_prefix/member';
...
@customElement("id-member-prefix-edit")
export class IdMemberPrefixEdit extends LitElement {
  constructor() { super(); }
  ...
  async submitForm(e: PointerEvent) {
    ...
    await PUT_MemberIdPrefix(this.prefixId);
  }
