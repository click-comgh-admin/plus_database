...
import { POST_MemberGroupingsMemberCategory } from '@@addons/network/members/groupings/member_categories/post';


@customElement("membership-groupings-member-categories-add-member-category")
export class MembershipGroupingsMemberCategoriesAddMemberCategory extends LitElement {
  constructor() { super(); }
  ...
  async submitForm(e: PointerEvent) {
    e.preventDefault();
    await POST_MemberGroupingsMemberCategory();
  }
