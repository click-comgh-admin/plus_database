...
@customElement("pdb-membership-update-photo")
export class PdbMembershipUpdatePhoto extends LitElement {
  constructor() { super(); }
  ...
  async submitForm(e: PointerEvent) {
    e.preventDefault();
    console.log({ e });
    await PATCH_MembershipUser(this.memberId, "Update Profile Image")
  }
