...
export class PdbMembershipMemberOrganizationUpdatePhoto extends LitElement {
              ...
              <div class="app-container--row !px-0">
                <div class="app-container--col-md-12">
                  ...
                  <form method="post" action="#" class="form !my-1" make-general-posts="members-user-organization"
                    ...
                    <pdb-membership-update-view-photo headTitle="${DATA.organizationName}'s Logo"
                      inputId="logo" inputName="logo" inputLabel="Update Logo"
                      ?inputRequired="${true}" currentImage="${DATA.logo}">
  ...
  async submitForm(e: PointerEvent) {
    e.preventDefault();
    // console.log({ e });
    await PATCH_MembershipOrganizationUser(this.memberId, "Update Logo")
  }
