...
import { ClockingDeviceSettingsFullModel, clockingSystemDeviceName } from '@@addons/interfaces/attendance/devices/settings/full';
...
import { DELETE_AttendanceClockingDeviceSettings } from '@@addons/network/attendance/devices/settings/delete';
...
@customElement("attendance-device-settings")
export class AttendanceDeviceSettings extends LitElement {
  constructor() { super(); }
  ...
  @property({ type: Array })
  private _userDeviceSettings: ClockingDeviceSettingsFullModel[] = [];
  ...
  @property({ type: String })
  private datatablePathUrl: string = "attendance/clocking-device/settings";
  ...
  private renderMemberInfo(data: any, type: any, userDeviceInfo: ClockingDeviceSettingsFullModel) {
  ...
  private renderDeviceInfo(data: any, type: any, userDeviceInfo: ClockingDeviceSettingsFullModel) {
    // console.log({userDeviceInfo});
  ...
  private __dataTable(url: string): DataTables_Settings_I {
    ...
    let dataTable: DataTables_Settings_I = {
      ...
      "columns": [
        {
          data: 'id',
          render: (data: any, type: any, userDeviceInfo: ClockingDeviceSettingsFullModel) => __this.renderMemberInfo(data, type, userDeviceInfo),
          orderable: true
        },
        {
          data: 'inTime',
          render: (data: any, type: any, userDeviceInfo: ClockingDeviceSettingsFullModel) => __this.renderDeviceInfo(data, type, userDeviceInfo),
          orderable: true
        },
  ...
  private view_device_info(userDeviceInfo: ClockingDeviceSettingsFullModel) {
    const memberId = userDeviceInfo.memberId;
    const memberInfo = userDeviceInfo.memberInfo;
  ...
  async deleteDeviceInfo(e: Event) {
    ...
    await DELETE_AttendanceClockingDeviceSettings(userUserId);
  }
