...
export async function POST_MemberVerificationAuto(autoVerificationId: Number | null = null,): Promise<any> {

  const _get_cookie = getUserLoginInfoCookie();
  // console.log({_get_cookie});

  const url = CONSTANTS.URLS.AKWAABA_API_BASE_URL + 'members/auto-verification'
    + (autoVerificationId === null ? "" : "/" + autoVerificationId),
    formData = {};

  return Swal.fire({
    title: autoVerificationId === null? 'Auto Verify Member(s)?': "Remove Auto Verification",
