...
export async function DELETE_GroupingsGroupMember(ID: Number,): Promise<any> {

  const _get_cookie = getUserLoginInfoCookie();
  // console.log({_get_cookie});

  const url = CONSTANTS.URLS.AKWAABA_API_BASE_URL + 'members/groupings/group-member/' + ID,
    formData = {};
