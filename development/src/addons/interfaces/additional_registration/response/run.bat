...
cd "Y:\htdocs\AMG\plus_db\client_dashboards\version_one\plus_database\development\src\addons\interfaces\additional_registration\response"
echo Directory Open && echo Generating File
quicktype -l ts main.json -t AdditionalRegistrationResponseModel -o index.ts --nice-property-names --prefer-unions --all-properties-optional && echo Type File Generated Successfully!
