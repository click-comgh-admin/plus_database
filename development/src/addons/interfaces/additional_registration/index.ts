// To parse this data:
//
//   import { Convert, AdditionalRegistrationModel } from "./file";
//
//   const additionalRegistrationModel = Convert.toAdditionalRegistrationModel(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.


export interface AdditionalRegistrationQuestionTypeModel {
    id: number;
    name: string;
}


export interface AdditionalRegistrationFormModel {
    items: Array<AdditionalRegistrationOnlyModel>
}

export interface AdditionalRegistrationOnlyModel {
    type?: number;
    branchId?: number;
...
export interface AdditionalRegistrationModel {
    id?:                     number;
    question?:               string;
    placeholderInstruction?: string;
    clientID?:               ClientID;
...
export class Convert {
    public static toAdditionalRegistrationModel(json: string): AdditionalRegistrationModel {
        return cast(JSON.parse(json), r("AdditionalRegistrationModel"));
    }

    public static additionalRegistrationModelToJson(value: AdditionalRegistrationModel): string {
        return JSON.stringify(uncast(value, r("AdditionalRegistrationModel")), null, 2);
    }
}
...
function transform(val: any, typ: any, getProps: any, key: any = '', parent: any = ''): any {
    function transformPrimitive(typ: string, val: any): any {
        if (typeof typ === typeof val) return val;// @ts-ignore
        if (typ === false) return;
    }
    ...
    if (typ === false) if (typ === false) return;
...
export const typeMap: any = {
    "AdditionalRegistrationModel": o([
        { json: "id", js: "id", typ: u(null, 0) },
        { json: "question", js: "question", typ: u(null, "") },
        { json: "placeholderInstruction", js: "placeholderInstruction", typ: u(null, "") },
        ...
        { json: "typeInfo", js: "typeInfo", typ: u(null, r("TypeInfo")) },
    ], false),
    "BranchID": o([
        { json: "id", js: "id", typ: u(null, 0) },
