...
// //
// //   const clockingDeviceRequestFullI = Convert.toClockingDeviceRequestFullModel(json);
// //
...
//     public static clockingDeviceRequestFullIToJson(value: ClockingDeviceRequestFullModel): string {
