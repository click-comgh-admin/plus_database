// To parse this data:
//
//   import { Convert, LocationElectoralAreaModel } from "./file";
//
//   const locationElectoralAreaModel = Convert.toLocationElectoralAreaModel(json);
//
...
export interface LocationElectoralAreaModel {
    id:          number;
...
export class Convert {
    public static toLocationElectoralAreaModel(json: string): LocationElectoralAreaModel {
        return cast(JSON.parse(json), r("LocationElectoralAreaModel"));
    }

    public static locationElectoralAreaModelToJson(value: LocationElectoralAreaModel): string {
        return JSON.stringify(uncast(value, r("LocationElectoralAreaModel")), null, 2);
    }
}
