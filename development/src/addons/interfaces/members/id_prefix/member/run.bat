...
cd "Y:\htdocs\AMG\plus_db\client_dashboards\version_one\plus_attendance\development\src\addons\interfaces\members\id_prefix\member"
echo Directory Open && echo Generating File
quicktype -l ts main.json -t  MembershipMemberIdPrefixModel -o index.ts --nice-property-names --prefer-unions --all-properties-optional && echo Type File Generated Successfully!
