...
cd "Y:\htdocs\AMG\plus_db\client_dashboards\version_one\plus_attendance\development\src/utils/interfaces/client/status/profession_status"
echo Directory Open && echo Generating File
quicktype -l ts main.json -t ProfessionStatusModel -o index.ts --nice-property-names --prefer-unions --all-properties-optional && echo Type File Generated Successfully!
